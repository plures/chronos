...
export declare const INTEGRITY_CHECK_REQUESTED: 'chronos.integrity.checkRequested';

/** Event tag emitted when a replay validation is requested. */
export declare const REPLAY_VALIDATION_REQUESTED: 'chronos.integrity.replayValidationRequested';
